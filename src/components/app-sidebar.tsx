...
const guestNav: NavMainItem[] = [
  { title: "Dashboard", url: "/dashboard", icon: <LayoutDashboardIcon /> },
  { title: "Mis viajes", url: "/trips", icon: <PlaneIcon /> },
]
                ...
                <Link to="/dashboard" className="flex items-center gap-3">
                  <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-transparent text-primary">
                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
                      className="size-6 fill-[#FF385C]" aria-hidden="true">
                  ...
                  <span className="text-xl font-bold tracking-tight text-[#FF385C]">airbnb</span>
                </Link>
              }
            />
          </SidebarMenuItem>
      ...
      <SidebarContent>
        <NavMain
          ...
          primaryAction={isHost ? {
            label: "Publicar alojamiento",
            url: "/host/listings/new",
            icon: <PlusCircleIcon />,
          } : undefined}
        />
      </SidebarContent>
